...
In Lambda School, web students join data science students for the computer science curriculum. Since web students are not familiar with Python, the materials this week provide a broad overview of Python. However, these materials represent a good approach to learning _any new language_ once you have a good handle on one language already.
